...
public class WrapperRestfulTaskResp extends WrapperTaskResp {

	public WrapperRestfulTaskResp(String id, String name, String documentation, String oldstatus, String newstatus,
