...
public class ClaimsCheckListInfo_ {
    ...
    public ClaimsCheckListInfo_ withCheckListId(BigInteger checkListId) {
        this.checkListId = checkListId;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withCheckListName(String checkListName) {
        this.checkListName = checkListName;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withCheckListGroup(String checkListGroup) {
        this.checkListGroup = checkListGroup;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withClaimHeaderId(BigInteger claimHeaderId) {
        this.claimHeaderId = claimHeaderId;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withClaimDetailId(BigInteger claimDetailId) {
        this.claimDetailId = claimDetailId;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withClaimFileId(BigInteger claimFileId) {
        this.claimFileId = claimFileId;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withClaimItemId(BigInteger claimItemId) {
        this.claimItemId = claimItemId;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withUcrNumber(String ucrNumber) {
        this.ucrNumber = ucrNumber;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withExternalRef(String externalRef) {
        this.externalRef = externalRef;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withLevel(String level) {
        this.level = level;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withIsChecked(String isChecked) {
        this.isChecked = isChecked;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withCheckedBy(String checkedBy) {
        this.checkedBy = checkedBy;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withCheckedDate(String checkedDate) {
        this.checkedDate = checkedDate;
        return this;
    }
    ...
    public ClaimsCheckListInfo_ withDeleteFlag(String deleteFlag) {
        this.deleteFlag = deleteFlag;
        return this;
    }
