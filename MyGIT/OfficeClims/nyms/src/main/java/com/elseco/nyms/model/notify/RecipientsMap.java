...
public class RecipientsMap {
	...
	public RecipientsMap(Member recipients, Map<String, String> htmlMapElementsForEmailBody,
			Map<String, String> htmlMapElementsForAttachments, Map<String, String> subjectElements) {
		super();
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		RecipientsMap other = (RecipientsMap) obj;
